    ...
    <footer className='pt-[140px] pb-[50px] bg-[#48409C]'>
        <Container>
            ...
            <Flex className='flex-col md:flex-row justify-between pt-20 px-4 md:px-0'>
                <div><p className='text-[#fefefee6] text-lg font-opne font-semibold'>@2021 Innovate.All rights reserved.</p></div>

                <div>
                    <p className='text-[#fefefee6] text-lg font-open font-semibold inline'>Terms & condition</p>
                    <p className='pl-[450px] text-[#fefefee6] text-lg font-open font-semibold inline'>Privacy policy</p>
                </div>
            </Flex>
